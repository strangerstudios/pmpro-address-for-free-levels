...
### Welcome to the Capture Name & Address for Free Levels or Offsite Gateway GitHub Repository
Add a description of the product here.

For more information please visit [Capture Name & Address for Free Levels or Offsite Gateway](https://www.paidmembershipspro.com/add-ons/capture-name-address-free-levels-offsite-gatewa)

## Installation ##
For detailed installation steps, visit the [Capture Name & Address for Free Levels or Offsite Gateway](https://www.paidmembershipspro.com/add-ons/capture-name-address-free-levels-offsite-gateway) page.

1. Download the current development ZIP file directly: `https://github.com/strangerstudios/pmpro-address-for-free-levels/archive/dev.zip`
...
1. Report [bugs/issues](https://github.com/strangerstudios/pmpro-address-for-free-levels/issues/new) on GitHub.
2. Work on any issues by submitting a Pull Request.

Here are some ways for **non-developers to contribute** to Capture Name & Address for Free Levels or Offsite Gateway:

1. Translate Capture Name & Address for Free Levels or Offsite Gateway into your own [language](https://www.paidmembershipspro.com/paid-memberships-pro-in-your-language/).
2. [Purchase a paid membership](https://paidmembershipspro.com/pricing) to help fund ongoing development and bug fixes.
3. Leave an honest review for [Capture Name & Address for Free Levels or Offsite Gateway](https://www.paidmembershipspro.com/submit-testimonial/).